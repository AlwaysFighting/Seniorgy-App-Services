...
class HideOutPage extends StatefulWidget {
  const HideOutPage({Key? key}) : super(key: key);

  @override
  State<HideOutPage> createState() => _HideOutPageState();
}

class _HideOutPageState extends State<HideOutPage> {
